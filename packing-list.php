          ...
          <div class="modal-dialog modal-lg">
            <div class="modal-content">
              <div class="modal-header">
                <h5 class="modal-title" id="myLargeModalLabel">Packing Information</h5>
...
<label for="item">Packing</label>
<input type="text" id="f1" name=f1 class="form-control"  placeholder="Packing" autocomplete="off" required >
</div>
...
<div class="card-footer">
                    <button type="submit" class="btn btn-primary btn-block mr-2">Add Packing</button>
                  </div>
