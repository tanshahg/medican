          ...
          <div class="modal-dialog modal-lg">
            <div class="modal-content">
              <div class="modal-header">
                <h5 class="modal-title" id="myLargeModalLabel">Add courier Company</h5>
...
<input name="f1" id="f1" class="form-control" placeholder="courier Company" required>
...
<div class="card-footer">
                    <button type="submit" class="btn btn-primary btn-block mr-2">Add courier</button>
                  </div>
