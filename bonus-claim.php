              ...
              <div class="col-12">
                <div class="card">
                  <div class="card-header">
                    <h3>Bonus Claim Detail</h3>
					
                  </div>
                  <div class="card-body">
                    <div class="table-responsive">
<table class="table table-striped table-hover text-dark mb-2" id="user_data" style="width:100% !important;">
...
if($groupcode==0)
$q="SELECT a.*,b.name,b.ccode,b.gcode,c.gname,d.name,f.name,e.date FROM `saledetail` as a,products as b,companygroups as c ,customers as d,sale as e, customers as f where b.ccode=$compnaycode and a.productcode=b.id and b.gcode=c.id and b.ccode=d.id and a.tableid=e.id and e.date>='$sdate' and e.date<='$edate' and a.bclaim>0 and e.customercode=f.id";
else
    $q="SELECT a.*,b.name,b.ccode,b.gcode,c.gname,d.name,f.name,e.date FROM `saledetail` as a,products as b,companygroups as c ,customers as d,sale as e, customers as f where b.ccode=$compnaycode and a.productcode=b.id and b.gcode=c.id and b.ccode=d.id and a.tableid=e.id and e.date>='$sdate' and e.date<='$edate' and a.bclaim>0 and e.customercode=f.id and b.gcode=$groupcode";
