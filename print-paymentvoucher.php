...
<div class="box">
  <div class="row">
    <div class="col-3 mt-5"><h5>Payment Voucher</h5>
      <p>
...
03327241482</div>
    ...
    <div class="col-3 text-right">
      ...
      <p>
       <?php  echo "
<img  src='barcode/barcode.php?codetype=Code39&size=40&text=448283".$sid."&print=true'/>";
?>
</p>
Print Date:-&nbsp;&nbsp;&nbsp;<b><?php echo $date ?></b>
  ...
  <div class="row mt-5 mb-3">
    <div class="col-4 rlo">Payment Amount</div>
    <div class="col-8 ulo"><?php echo $row[9]?></div>
  </div>

  <div class="row my-3">
    <div class="col-4 rlo">Amount in words</div>
    <div class="col-8 ulo"><?php echo numberTowords($row[9])?></div>
  </div>

  <div class="row my-3">
    <div class="col-4 rlo">To Mr. / M/s</div>
...
<body >
  ...
  setTimeout(function(){ window.location ="payment-voucher.php" }, 1000);
    };
