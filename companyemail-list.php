...
include "db.php";
$q="select a.*,b.name
from companyemails as a ,companies as b
where a.ccode=b.id;
";
...
<label for="item">Company Email </label>
<input type="email" id="f2" name=f2 class="form-control"  placeholder="Company IBL" autocomplete="off" required >
</div>
...
$.each(others,function(key,input) {
  ...
  $.ajax({
         url: "ajaxcall/add-companyemails.php",
   method: "post",
   data:  formData,
   contentType: false,
         cache: false,
