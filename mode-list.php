          ...
          <div class="modal-dialog modal-lg">
            <div class="modal-content">
              <div class="modal-header">
                <h5 class="modal-title" id="myLargeModalLabel">Area Customer Mode</h5>
...
<label for="item">Customer Mode</label>
<input type="text" id="f1" name=f1 class="form-control"  placeholder="customer mode" autocomplete="off" required >
</div>
...
<div class="card-footer">
                    <button type="submit" class="btn btn-primary btn-block mr-2">Add Customer Mode</button>
                  </div>
