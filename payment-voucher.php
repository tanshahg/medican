...
where a.cid=b.id and a.paymentmode=c.id and a.paymentmode<>1 and a.date >='$sdate' AND  a.date<='$edate' and a.accounthead='payment ' order by date";
...
$.each(others,function(key,input) {
  ...
  $.ajax({
         url: "ajaxcall/add-paymentvoucher.php",
   method: "post",
   data:  formData,
   contentType: false,
         cache: false,
