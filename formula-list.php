          ...
          <div class="modal-dialog modal-lg">
            <div class="modal-content">
              <div class="modal-header">
                <h5 class="modal-title" id="myLargeModalLabel">Formula Information</h5>
...
<input type="text" id="f1" name=f1 class="form-control"  placeholder="Formula" autocomplete="off" required >
</div>
...
<div class="card-footer">
                    <button type="submit" class="btn btn-primary btn-block mr-2">Add Formula</button>
                  </div>
