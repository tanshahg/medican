...
where a.cid=b.cid and a.paymentmode=c.id and salemanid<1 and a.paymentmode<>1 and a.date >='$sdate' AND  a.date<='$edate' and a.accounthead='payment' order by date";
