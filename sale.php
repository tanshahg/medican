              ...
              <div class="col-12">
                <div class="card">
                  <div class="card-header">
                    <h3>Sale (Previous id <?php echo $previousid ?>)</h3>
...
<input type="text" id="f13" name=f13 class="form-control fetch_results" placeholder="%" style="width:50px !important;" readonly tabindex="-1">
</div>
</div>
...
<input type="text" id="f22" name=f22  class="form-control fetch_results input-sm" placeholder="%" style="width:50px !important" readonly tabindex="-1">
</div>
</div>
<div class="form-group">
...
<input type="text" id="f221" name=f221 class="form-control fetch_results" placeholder="%" style="width:50px !important" readonly tabindex="-1">
</div>
...
<input type="text" id="f15" name="f15" class="form-control fetch_results"  tabindex="-1">
</div>

<div class="form-group">
<label for="item">Total Amount</label>
<input type="text" id="f16" name="f16" class="form-control fetch_results"  tabindex="-1">
</div>
</div>
    ...
    <button id="additem" type=submit class="btn btn-primary " style="width:100%">Add Item</button>
      </div>
    </div>
  </div>
      <div class="col-md-8">
...
$("#f9,#f10,#f12,#f13,#f14,#f11,#f8").change(function(){
  var pid=$("#f5").val();
  var pcode=$("#f6").val();
  var btno=$("#f7").val();
  var expdate=$("#f8").val();
  ...
  $.ajax({
   ...
   method: "post",
   data:  {pid:pid,pcode:pcode,btno:btno,expdate:expdate,mrp:mrp,tp:tp,dis:dis,nrate:nrate,qty:qty,gst:gst,extra:extra,bonus:bonus,rr:0},
   cache: false,
   dataType: "json",
