...
$q2="select a.*,b.id,b.name,c.pmode
from payments as a ,customers as b,paymentmode as c
where a.cid=b.id and a.paymentmode=c.id and a.paymentmode<>1 and a.date >='$sdate' AND  a.date<='$edate' and a.accounthead='rsimple' order by date";
...
<a href=\"print-simplervoucher.php?code=$row[0]\"><button  class='btn btn-primary btn-sm'><i class='fas fa-print'></i></button></a>
</td></tr>";
}
}
          ...
          <div class="modal-dialog modal-lg">
            <div class="modal-content">
              <div class="modal-header">
                <h5 class="modal-title" id="myLargeModalLabel">Reciept Voucher Simple</h5>
...
<div class="form-group">
<label for="item">Select Client</label>
...
<input type="text" id="ff3" name=ff3 class="form-control" readonly>
</div>
...
?>        
  ...
  footerCallback: function ( row, data, start, end, display ) {
    ...
    $( api.column(6).footer() ).html(numberWithCommas(total));
